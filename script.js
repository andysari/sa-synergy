document.addEventListener("DOMContentLoaded", () => {
  ...
  const testimonies = [
    ...
    },
    {
      ...
      texte: "Très pédagogue et sérieux. C'est un professeur très polyvalent qui s'intéresse à énormément de domaines tout en étant passionné. Très curieux et se posant beaucoup de questions, il a un sens critique affûté. Pour finir, il possède beaucoup de compétences et de connaissance à transmettre, cela est symbolisé par son nombre de certifications et de formations passées.",
