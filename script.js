document.addEventListener("DOMContentLoaded", () => {
  ...
  function showNextLine() {
    matrixLines.forEach((l, idx) => l.style.display = idx === curLine ? "block" : "none");
    curLine = (curLine + 1) % matrixLines.length;
  }
  showNextLine();
  ...
  const testimonies = [
    ...
    { nom:"Léontin", role:"Étudiant BTS MCO", texte:"Je tiens à exprimer ma profonde gratitude envers mon formateur pour son soutien inestimable dans la matière « gestion opérationnelle ». Grâce à ses enseignements attentifs et à sa disponibilité exemplaire, j'ai pu valider mon BTS avec une note exceptionnelle de 18 en gestion opérationnelle.", image:"assets/leontin.jpg" },
    { nom:"Nicolas", role:"Étudiant BTS Comptabilité et Gestion", texte:"J’ai pu approfondir mes connaissances sur le bilan et le compte de résultat pour mon diplôme. Je recommande vivement Andy.", image:"assets/nicolas.jpg" }
  ];
